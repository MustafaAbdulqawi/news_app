import 'dart:convert';
LastMonthRespose lastMonthResponseFromJson(String str) => LastMonthRespose.fromJson(json.decode(str));
class LastMonthRespose {
  LastMonthRespose({
      String? status, 
      num? totalResults, 
  ...
  LastMonthRespose.fromJson(dynamic json) {
    _status = json['status'];
